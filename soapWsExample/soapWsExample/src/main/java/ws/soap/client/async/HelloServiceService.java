 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://soap.ws/", wsdlLocation = "http://localhost:8080/soapWsExample/helloMsg?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://soap.ws/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soapWsExample/helloMsg?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://soap.ws/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.ws/", "HelloServicePort"), HelloService.class, features);
    }
